...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-014-b-project-trivia-react-redux.git`
...
6. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-014-b-project-trivia-react-redux/pulls)
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-014-b-project-trivia-react-redux/pulls) e confira que o seu _Pull Request_ está criado
